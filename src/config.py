...
def asc_config(parser):
    ...
    parser.add_argument('--rnn_num_layers',default=1,type=int,required=False,help='(default=%(default)f)')
    parser.add_argument('--sbatch',default=64,type=int,required=False,help='(default=%(default)f)')
    parser.add_argument('--rnn_num_directions',default=1,type=int,required=False,help='(default=%(default)f)')
    ...
    parser.add_argument('--build_adapter_grow', action='store_true')
    ...
    parser.add_argument('--apply_bert_output', action='store_true', help='whether apply adapter to BERTOutput layer')
    ...
    parser.add_argument('--task_based', action='store_true')
    parser.add_argument('--instance_based', action='store_true')
    ...
    parser.add_argument('--bingdomains_num_train_epochs_multiplier', type=int, default=0)
...
def augment_config(parser):
    ...
    parser.add_argument('--e_start_mixup',type=int,default=25)
    ...
    parser.add_argument('--ntmix',type=int,default=1)
    ...
    parser.add_argument('--use_dissimilar', action='store_true')
    ...
    parser.add_argument('--feature_based',action='store_true')
...
def contrastive_config(parser):
    ...
    parser.add_argument('--smooth_ce',action='store_true')
    parser.add_argument('--as_multilabel',action='store_true')
    parser.add_argument('--mix_id', action='store_true')
