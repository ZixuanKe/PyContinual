...
do
    ...
    --unseen \
    --ent_id \
    --model_path "./models/fp32/til_classification/femnist/mlp_hat_$id" \
    --resume_from_file "./models/fp32/til_classification/femnist/mlp_hat_$id"
done
#--nepochs 1
