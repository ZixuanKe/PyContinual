...
#SBATCH -p gpu20
#SBATCH -t 45:00:00
#SBATCH -o til_asc_large_capsule_mask_imp_route_share_list_4-%j.out
#SBATCH --gres gpu:1
...
do
    ...
    --note random$id,imp,transfer_route,share,rlarger_share,large,larger_as_list\
    --ntasks 19 \
    --exp 2layer_whole \
    --idrandom $id \
    ...
    --model_path "./models/fp32/til_classification/asc/capsule_mask_imp_route_share_large_list_$id" \
    --save_model
done
