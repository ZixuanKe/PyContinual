...
#SBATCH -p gpu20
#SBATCH -t 40:00:00
#SBATCH -o til_nli_capsule_mask_imp_route_share_4-%j.out
#SBATCH --gres gpu:1
...
do
    ...
    --share_conv \
    --larger_as_share\
    --model_path "./models/fp32/til_classification/nli/capsule_mask_imp_route_list_$id" \
    --save_model\
    --resume_model \
...
#    --train_batch_size 10 \
#    --learning_rate 3e-4
#    --model_path "./models/fp32/til_classification/nli/capsule_mask_imp_route_list_2000_$id" \
