...
do
    ...
    --note random$id,amix,Attn-HCHP-Outside,distill_head,sup,augment_distill,selfattn,naug1,task_based,ent_id\
    --ntasks 19 \
    --nclasses 3 \
    --task asc \
    ...
    --naug 1 \
    --ent_id \
    --model_path "./models/fp32/dil_classification/asc/adapter_mask_amix_ent_$id" \
    --save_model
done
#    --use_dissimilar \
