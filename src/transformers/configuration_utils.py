...
class PretrainedConfig(object):
    ...
    def __init__(self, **kwargs):
        ...
        #my config ===
        self.apply_bert_output = False
        self.apply_bert_attention_output = False
        self.apply_one_layer_shared = False
        self.apply_two_layer_shared = False
        self.build_adapter_mask = False
        self.build_adapter = False
        self.build_adapter_ucl = False
        self.build_adapter_owm = False
        self.build_adapter_capsule_grow = False
        self.build_adapter_grow = False
        self.build_adapter_attention_mask = False
        self.build_adapter_two_modules = False
        self.build_adapter_capsule_mask = False
        self.build_adapter_capsule = False
        self.build_adapter_mlp_mask = False
        self.adapter_size = 2000
