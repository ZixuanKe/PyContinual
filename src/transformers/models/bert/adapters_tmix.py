...
class BertAdapterGrow(BertAdapter):
    ...
    def forward(self,x,t):
        if transformer_args.use_gelu:
            h=self.gelu(self.fc1[t](x))
            h=self.gelu(self.fc2[t](h))
        else:
...
class BertAdapterMask(BertAdapter):
    ...
    def forward(self,x,t,s,smax=400,pre_t=None,l=None,pre_task_contrast=False):
        #TODO: someday, we may make use of pre_task_contrast
        #TODO: mixup here in adapter
